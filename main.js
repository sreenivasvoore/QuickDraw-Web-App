...
var random_sketch = quick_draw_data_set[random_no];
document.getElementById("drawn_sketch").innerHTML = "Sketch To Be Drawn: " + random_sketch;
...
function updateCanvas() {
    ...
    console.log(quick_draw_data_set[random_no]);
    document.getElementById("drawn_sketch").innerHTML = "Sketch To Be Drawn: " + quick_draw_data_set[random_no];
}
...
function gotResult(error, results) {
    if (error) {
        ...
        document.getElementById("guessed_sketch_accuracy").innerHTML = 'Confidence: ' + Math.round(results[0].confidence * 100) + '%';
    }
}
